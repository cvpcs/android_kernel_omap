/*
 * linux/sound/soc/codecs/tlv320dac3100-biquad.h
 *
 *
 ...
 *						        21-Jul-2010
 * Rev 0.3      Added the dac3100_parse_data struct     
 *                                                      29-Jul-2010 
 */

#ifndef _TLV320DAC3100_BIQUAD_H
#define _TLV320DAC3100_BIQUAD_H
...
/*******************************************************************************
 * DAC3100 Equalizer related defines and structs 
 ******************************************************************************/
#define DAC3100_HP_EQ_SELECT		1
#define DAC3100_SPK_EQ_SELECT		2
#define DAC3100_DIRECT_EQ_SELECT	3
...
/* @struct dac3100_parse_data - . Parser info structure 
 *
 * Structure used to parse through the EQ Array defined in the
 * tlv320dac3100_eq_coeff.h This structure will be initialized
